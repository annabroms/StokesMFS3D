...
for i = 1:length(tolvec)
    ...
    TGplus = YT*UT';
    AA = TGplus-TGplus';
    aa(i) = norm(AA); %this is the symmetry error in the pseudoinverse
    %eTG_plus = eig(TGplus); 
